...
export default [
  {
    ...
    list: ["React project", "Redux", "React Router", "React Hooks"],
  ...
  },
  {
    ...
    list: ["GraphQL + Postgres", "Node JS", "Highcharts", "Apollo Client"],
  ...
  },
  {
    ...
    list: ["React project", "Redux", "React Hooks", "Test framework 'Jest'"],
